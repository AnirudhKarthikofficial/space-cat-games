        ...
        <div className="games-grid" id="gamesGrid">
            ...
            <div className="game-item">
                <button
                    ...
                    title="The Hardest Game"
                >
                    <img src="images/suika-icon.png" alt="The Hardest Game" />
                </button>
                <p>Suika Game</p>
            </div>
            <div className="game-item">
            ...
            <div className="game-item">
                <button
                    ...
                    title="when"
                >
                    <img src="images/thetypinggame.png" alt="cat." />
                </button>
                <p>The Typing Game</p>
            </div>
            <div className="game-item">
                <button
                    ...
                    title="big yellow storage"
                >
                    <img src="images/pickalock.png" alt="big yellow storage" />
                </button>
                <p>Pick a Lock</p>
            </div>
            <div className="game-item">
                <button
                    ...
                    title="big yellow storage"
                >
                    <img src="images/cubit.png" alt="big yellow storage" />
                </button>
                <p>Cubit</p>
            </div>
            <div className="game-item">
            ...
            <div className="game-item">
                <button
                    ...
                    title="MotoX3M"
                >
                    <img src="/images/motocap.avif" alt="motocap.avif" />
                </button>
                <p>MotoX3M</p>
            </div>
            <div className="game-item">
                ...
                >
                    <img
                        src="https://i.ibb.co/hR1ZK9Yc/Doodle-Jump.png"
                        alt="Doodle Jump"
                    />
                </button>
                <p>Doodle Jump</p>
            ...
            <div className="game-item">
                ...
                >
                    <img
                        src="https://i.ibb.co/LD4Z3872/pong-1650079489009.jpg"
                        alt="Ping Pong"
                    />
                </button>
                <p>Ping Pong</p>
            ...
            <div className="game-item">
                ...
                >
                    <img
                        src="https://i.ibb.co/Kc1J3Nhj/Mr-Smiley-Face-from-Minesweeper-render.webp"
                        alt="Minesweeper"
                    />
                </button>
                <p>Minesweeper</p>
            ...
            <div className="game-item">
                ...
                >
                    <img
                        src="https://i.ibb.co/GfPzN9Ns/images-5.jpg"
                        alt="Learn to Fly 3"
                    />
                </button>
                <p>Learn to Fly 3</p>
            ...
            <div className="game-item">
                ...
                >
                    <img
                        src="https://i.ytimg.com/vi/qIBxUAp-Gk8/maxresdefault.jpg"
                        alt="Learn to Fly"
                    />
                </button>
                <p>Learn to fly</p>
            ...
            <div className="game-item">
                ...
                >
                    <img
                        src="images/icon_300x300_papassushiria.jpg"
                        alt="Papa's Sushiria"
                    />
                </button>
                <p>Papa's Sushiria</p>
            ...
            <div className="game-item">
                <button
                    ...
                    title="looks like counter strike 1"
                >
                    <img
