    ...
    <div className="container">
        ...
        <section className="credits-section">
            ...
            <ul className="credits-list">
                ...
                <li>
                    <strong>Yarn: </strong>Created by YarnPKG.{" "}
                    <a href="https://yarnpkg.com/">https://yarnpkg.com/</a>
                </li>
                <li>
                    <strong>Visual Studio Code: </strong>IDE used at Ijichi Systems.{" "}
                ...
                <li>
                    <strong>Jekyll: </strong>Static Site Converter.{" "}
        ...
        <div className="container">
            <div className="footer-content">
                ...
                <p className="copyright">
                    © 2025 Nijika Softworks &amp; Starry Systems. All rights reserved.
                </p>
